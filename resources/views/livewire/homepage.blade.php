          ...
          <div class="row align-items-center justify-content-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
              <div class="block text-center text-lg-start pe-0 pe-xl-5">
                <h1 class="text-capitalize mb-4">We Are KoTaSang</h1>
                <p class="mb-4">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vulputate libero vel odio cursus facilisis. Cras at est laoreet ligula pulvinar egestas ac ac urna.</p> <a type="button"
            ...
            <div class="col-lg-6">
              <div class="ps-lg-5 text-center">
                <img loading="lazy" decoding="async"
                  src="{{ asset('frontend/images/anim.png') }}"
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 service-item">
              <a class="text-black" href="service-details.html">
                <div class="block"> <span class="colored-box text-center h3 mb-4">{{ $c }}</span>
                  <h3 class="mb-3 service-title">{{ $s->title }}</h3>
                  <p class="mb-0 service-description">{{ $s->short_desc }}</p>
                </div>
              </a>
            </div>
            @php
