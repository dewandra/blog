                    ...
                    @foreach ($members as $m)
                        <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
                            <div class="card bg-transparent border-0 text-center">
                                <div class="card-img">
                                    <img loading="lazy" decoding="async" src="{{ asset('storage/'.$m->image) }}" alt="Scarlet Pena" class="rounded w-100" width="300" height="100">
                                    <ul class="card-social list-inline">
                                        <li class="list-inline-item"><a class="facebook" href="https://www.facebook.com"><i class="fab fa-facebook"></i></a>
                                        </li>
                                        <li class="list-inline-item"><a class="twitter" target="__blank" href="{{ $m->x_url }}"><i class="fab fa-twitter"></i></a>
                                        </li>
                                        <li class="list-inline-item"><a class="instagram" target="__blank" href="{{ $m->ig_url }}"><i class="fab fa-instagram"></i></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body">
