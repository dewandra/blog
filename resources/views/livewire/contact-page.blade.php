							...
							<div class="contact-form">
								<form wire:submit="submit">
									...
									<div class="form-group mb-4 pb-2">
										...
										<textarea wire:model="message" class="form-control shadow-none" id="message" rows="3" name="message"></textarea>
									</div>
						...
						<div class="col-lg-6 mt-5 mt-lg-0">
							<div class="contact-info">
								<div class="block mt-0">
									...
									<div class="content">Mari Bergabung Bersama Komunitas Kami
										<br> <a href="tel:+XXX111222">+62xxxxxxxx</a> 
										<br>Senin - Jumat
										<br>08:00 - 10:00</div>
								</div>
								<div class="block mt-4">
									<h4 class="h5">Rampal</h4>
									<div class="content">Lapangan Rampal,
										<br>122.
										<br>Taman</div>
								</div>
								<div class="block mt-4">
									<h4 class="h5">Car Free Day</h4>
									<div class="content">Perpus Kota,
										<br>133.
										<br>Depan</div>
								</div>
								<div class="block">
