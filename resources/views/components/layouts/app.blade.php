	...
	<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
		<div class="container">
			<a class="navbar-brand" wire:navigate href="{{ route('home') }}">
				<img loading="prelaod" decoding="async" class="img-fluid" width="160" src="{{ asset('frontend/images/logo1.png') }}" alt="Wallet">
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav m-auto mb-2 mb-lg-0">
					...
					<li class="nav-item "> <a class="nav-link" wire:navigate href="{{ route('page',1) }}">About Us</a></li>
					<li class="nav-item "> <a class="nav-link" wire:navigate href="{{ route('services') }}">Services</a></li>
					<li class="nav-item "> <a class="nav-link" wire:navigate href="{{ route('teams') }}">Our Team</a></li>
					<li class="nav-item "><a class="nav-link " wire:navigate href="{{ route('blogs') }}">Blog</a></li>
		...
		<div class="row justify-content-between">
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="mb-2"><a wire:navigate href="{{ route('page',2) }}">Pet Training</a>
						</li>
						<li class="mb-2"><a wire:navigate href="{{ route('page',3) }}">Pet Grooming</a>
						</li>
						<li class="mb-2"><a wire:navigate href="{{ route('page',4) }}">Pet Hotel</a>
						</li>
						<li class="mb-2"><a wire:navigate href="{{ route('page',5) }}">Pet Care</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="list-inline-item me-4"><a class="text-black" wire:navigate href="{{ route('page',2) }}">Privacy Policy</a>
                        </li>
						<li class="list-inline-item me-4"><a class="text-black" wire:navigate href="{{ route('page',3) }}">Terms &amp; Conditions</a>
                        </li>
					</ul>
				</div>
			</div>			
